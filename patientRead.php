...
<div class="content read">
	<h2>Read patients</h2>
	<a href="patientCreate.php" class="create-contact">Create patient</a>
	<table>
        <thead>
            <tr>
                <td>Patient ID</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="patientUpdate.php?id=<?=$patient['patient_id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="patientDelete.php?id=<?=$patient['patient_id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="patientRead.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_patients): ?>
		<a href="patientRead.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
