...
if (isset($_GET['doctor_id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            header('Location: doctorRead.php');
            exit;
        }
    }
} else {
...
<div class="content delete">
    ...
    <div class="yesno">
        <a href="doctorDelete.php?doctor_id=<?=$doctor['doctor_id']?>&confirm=yes">Yes</a>
        <a href="doctorDelete.php?doctor_id=<?=$doctor['doctor_id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
